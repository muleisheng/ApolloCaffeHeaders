...
class PyramidImageRuiDataParam {
public:
...
template<typename Dtype>
class DetectionRuiOutputLayer: public ROIOutputLayer<Dtype> {
public:
    explicit DetectionRuiOutputLayer(const LayerParameter& param) :
            ROIOutputLayer<Dtype>(param) {
    }
    virtual ~DetectionRuiOutputLayer() {
    }
    ;
...
protected:
    PyramidImageRuiDataParam<Dtype> pyramid_image_data_param_;
