...
class EltwiseEuclideanLossLayer : public caffe::Layer<Dtype> {
public:
    explicit EltwiseEuclideanLossLayer(const caffe::LayerParameter& param)
    ...
    const char* type() const override {
        return "SmartsegEltwiseEuclideanLoss";
    }
protected:
