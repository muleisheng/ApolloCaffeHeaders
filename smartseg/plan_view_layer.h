...
class PlanViewLayer : public caffe::Layer<Dtype> {
public:
    explicit PlanViewLayer(const caffe::LayerParameter& param)
        : caffe::Layer<Dtype>(param) {
        _param = param.smartseg_plan_view_param();
    }
