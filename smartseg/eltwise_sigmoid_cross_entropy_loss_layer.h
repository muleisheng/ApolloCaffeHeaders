...
class EltwiseSigmoidCrossEntropyLossLayer : public caffe::Layer<Dtype> {
public:
    explicit EltwiseSigmoidCrossEntropyLossLayer(const caffe::LayerParameter& param)
    ...
    const char* type() const override {
        return "SmartsegEltwiseSigmoidCrossEntropyLoss";
    }
protected:
